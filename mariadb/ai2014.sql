...
--
-- Host: localhost    Database: atominterferometer2014
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'atominterferometer2014'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`AI_root`@`%` PROCEDURE `addMesswert`(IN p_Messwert_Nr int,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`AI_root`@`%` PROCEDURE `getNextNumbers`()
BEGIN
DECLARE test INT;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`AI_user`@`%` PROCEDURE `getNextNumbers2`()
BEGIN
DECLARE test INT;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`AI_root`@`%` PROCEDURE `getNumbersForNextMessreihe`()
BEGIN
DECLARE test INT;
...
/*!50013 DEFINER=`AI_user`@`%` SQL SECURITY DEFINER */
...
/*!50001 SET collation_connection      = utf8_general_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`AI_root`@`%` SQL SECURITY DEFINER */
